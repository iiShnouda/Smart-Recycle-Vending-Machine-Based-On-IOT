...
Env overrides (all optional):
  ...
  RECYCLE_CONF   accept confidence threshold          (default 0.55)
  RECYCLE_BURST  seconds to watch the item            (default 1.5)
...
CONF  = float(os.environ.get("RECYCLE_CONF", "0.55"))
BURST = float(os.environ.get("RECYCLE_BURST", "1.5"))
